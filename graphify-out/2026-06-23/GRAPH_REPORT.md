...
## Corpus Check
- 59 files · ~13,794 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 334 nodes · 521 edges · 20 communities (15 shown, 5 thin omitted)
...
- [[_COMMUNITY_News Controller|News Controller]]
...
Cohesion: 0.09
Nodes (16): FactCheck, factCheckSchema, sourceSchema, SavedArticle, savedArticleSchema, User, userSchema, AnalyticsService (+8 more)
...
Cohesion: 0.10
Nodes (12): connectDB(), config, __dirname, envVarsSchema, __filename, { value: envVars, error }, seedAdmin(), sampleNews (+4 more)

### Community 4 - "DB & Constants"
Cohesion: 0.12
Nodes (9): API_LIMITS, REPORT_STATUS, VERDICTS, Report, reportSchema, CredibilityService, ExplanationService, NewsService (+1 more)
...
Cohesion: 0.19
Nodes (13): ROLES, adminMiddleware(), authMiddleware(), authLimiter, globalLimiter, verificationLimiter, router, router (+5 more)
...
### Community 10 - "News Controller"
Cohesion: 0.31
Nodes (4): NewsController, analyzeSchema, checkSchema, urlCheckSchema

### Community 11 - "Claim Extraction Service"
Cohesion: 0.22
Nodes (3): NewsAnalysisController, ClaimExtractionService, responseFormatter

### Community 14 - "News Service"
Cohesion: 0.16
Nodes (8): llmConfig, ProviderFactory, buildAnalysisPrompt(), BaseProvider, GeminiProvider, GroqProvider, normalizeAnalysisResponse(), safeParseJSON()
...
Cohesion: 0.17
Nodes (6): LLMService, AnalysisHistory, analysisHistorySchema, NewsAnalysisService, AppError, logger
...
- **Why does `BadRequestError` connect `Reports & Saved Articles` to `Community 19`, `Admin Validation`, `Auth Controller`, `News Controller`?**
